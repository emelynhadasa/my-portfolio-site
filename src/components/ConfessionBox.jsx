...
const ConfessionBox = () => {
  ...
  return (
    <div className="confession-box">
      <h2>You might want to <br/> approach me by e-mail <img src="/images/mail.png" className="mail-icon" alt="Mail Icon" /></h2>
      <p>
        Don’t worry! Your message will be sent<br /> to Em’s personal Google Mail. <img src="/images/wink2.png" className="wink-icon" alt="Wink Icon" />
      </p>
